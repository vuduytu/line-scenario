...
use Cnc\LineScenario\Http\Requests\API\Admin\ScenarioStoreRequest;
use Cnc\LineScenario\Http\Requests\API\Admin\ScenarioUpdateRequest;
use Illuminate\Http\Request;
use Cnc\LineScenario\Http\Controllers\Controller;
use Cnc\LineScenario\Http\Resources\BaseDataCollection;
use Cnc\LineScenario\Http\Resources\ScenarioSettingResource;
